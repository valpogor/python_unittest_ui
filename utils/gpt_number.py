...
def ai(file):
    ...
    pi=math.pi
    mpn = MostProbableNumber(1000)
    mpn1 = MostProbableNumber(1000)
    mpn2 = MostProbableNumber(1000)
    mpn3 = MostProbableNumber(1000)
    mpn4 = MostProbableNumber(1000)
    mpn5 = MostProbableNumber(1000)
    lot=[]
    for num in first:
        mpn.new_number(num)
    # print(mpn.most_probable())
    for num1 in second:
